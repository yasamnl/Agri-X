...
import { Leaf, Mail, Lock, Eye, EyeOff, AlertCircle, Sprout, Sun, Moon } from 'lucide-react';
...
export default function LoginPage() {
  ...
  // ✅ Validasi callbackUrl untuk security (cegah open redirect)
  useEffect(() => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // ✅ REDIRECT KE CALLBACK URL (bukan hardcoded /katalog)
      // Validasi sekali lagi untuk security
      if (callbackUrl && callbackUrl.startsWith('/') && !callbackUrl.startsWith('//')) {
        setTimeout(() => {
