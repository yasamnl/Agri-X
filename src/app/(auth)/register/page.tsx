  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-primary/5 via-background to-secondary/5">
      <div className="flex flex-col items-center gap-4">
        ...
        <p className="text-text-secondary">Memuat halaman registrasi...</p>
      </div>
    </div>
  );
}
...
// ============================================================================
// ✅ REGISTER CONTENT (menggunakan useSearchParams)
// ============================================================================
...
<div>
  ...
  <div className="relative">
    ...
    <input
      ...
      autoComplete="tel"
      className={`w-full input py-3 rounded-xl border border-border focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all duration-200 ${
        formData.phone || isFocused.phone ? 'pl-4 pr-4' : 'pl-12 pr-4'
      }`}
    />
  </div>
</div>
