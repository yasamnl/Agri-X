...
export async function GET(req: NextRequest, { params }: Params) {
  try {
    ...
    console.log('💳 [PAYMENT STATUS] Checking order:', { orderId, userId });
    ...
    console.log('📦 [PAYMENT STATUS] Order loaded:', {
      orderId: order.id,
    ...
    if (order.payment_method === 'cod') {
      console.log('💵 [PAYMENT STATUS] COD order - skip Midtrans check');
    ...
    if (order.payment_status === PAYMENT_STATUS.PAID) {
      console.log('✅ [PAYMENT STATUS] Already paid - skip Midtrans check');
    ...
    if (midtransReference) {
      try {
        console.log('🔍 [PAYMENT STATUS] Checking Midtrans:', midtransReference);
        
        midtransStatus = await coreApi.checkTransaction(midtransReference);
      ...
      console.warn('⚠️ [PAYMENT STATUS] No transaction_id or va_number found');
    }
    ...
    if (shouldUpdateDb && 
      ...
      console.log('🔄 [PAYMENT STATUS] Updating order:', {
        orderId,
      ...
      try {
        ...
        console.log('✅ [PAYMENT STATUS] Order updated successfully');
