...
export async function PATCH(req: NextRequest, { params }: Params) {
  ...
  try {
    ...
    if (process.env.NODE_ENV === 'development') console.log('📦 [ORDER STATUS] Update request:', {
      orderId,
      status,
      courier,
      trackingNumber,
    ...
    try {
      ...
      if (process.env.NODE_ENV === 'development') console.log('📦 [ORDER STATUS] Current order:', {
        id: order.id,
      ...
      if (process.env.NODE_ENV === 'development') console.log('📦 [ORDER STATUS] Update query:', updateQuery);
      if (process.env.NODE_ENV === 'development') console.log('📦 [ORDER STATUS] Update values:', updateValues);
      ...
      if (process.env.NODE_ENV === 'development') console.log('✅ [ORDER STATUS] Order updated successfully');
      ...
      if (order.is_pre_order && status === 'shipped') {
        ...
        if (process.env.NODE_ENV === 'development') console.log('📦 [PO] Updated po_status to shipped');
      }
      ...
      try {
        ...
        if (notificationResult) {
          if (process.env.NODE_ENV === 'development') console.log('📧 [NOTIFICATION] Sent:', notificationResult);
        }
      ...
      if (process.env.NODE_ENV === 'development') console.log('✅ [ORDER STATUS] Transaction committed');
