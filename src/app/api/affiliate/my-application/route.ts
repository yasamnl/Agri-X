    ...
    return NextResponse.json({
      ...
      data: {
        ...
        stats: {
          ...
          totalTransactions: Number(transactionStats[0]?.total_transactions || 0),
          totalRevenue: Number(transactionStats[0]?.total_revenue || 0),
          totalCommission: Number(transactionStats[0]?.total_commission || 0),
          availableBalance: Number(earningsStats[0]?.available_balance || 0),
          pendingCommission: Number(earningsStats[0]?.pending_commission || 0),
          totalWithdrawals: Number(withdrawalStats[0]?.total_withdrawals || 0),
          totalWithdrawn: Number(withdrawalStats[0]?.total_withdrawn || 0),
        },
        ...
        recentWithdrawals: recentWithdrawals.map((w: any) => ({
          id: Number(w.id),
          bank: w.bank,
