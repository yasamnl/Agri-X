...
export async function POST(req: NextRequest) {
  try {
    ...
    if (process.env.NODE_ENV === 'development') console.log('[Midtrans] Processing payment. Ref ID:', dbOrderId, 'User:', userId);
    ...
    if (process.env.NODE_ENV === 'development') console.log('[Midtrans] Order Found. ID:', internalOrderId, 'Phone:', customerPhone);
    ...
    if (process.env.NODE_ENV === 'development') console.log('GROSS AMOUNT:', grossAmount);
    if (process.env.NODE_ENV === 'development') console.log('PAYMENT TYPE:', paymentType);
    if (process.env.NODE_ENV === 'development') console.log('====================');
    ...
    if (process.env.NODE_ENV === 'development') console.log('FINISH URL:', finishUrl);
    if (process.env.NODE_ENV === 'development') console.log('UNFINISH URL:', unfinishUrl);
    if (process.env.NODE_ENV === 'development') console.log('ERROR URL:', errorUrl);
  ...
  if (process.env.NODE_ENV === 'development') console.log('====================');
  if (process.env.NODE_ENV === 'development') console.log('MIDTRANS PAYLOAD');
  if (process.env.NODE_ENV === 'development') console.log(JSON.stringify(payload, null, 2));
  if (process.env.NODE_ENV === 'development') console.log('====================');

  if (process.env.NODE_ENV === 'development') console.log('MIDTRANS RESPONSE');
  if (process.env.NODE_ENV === 'development') console.log(errText);
  if (process.env.NODE_ENV === 'development') console.log('====================');
...
// DEBUG
if (process.env.NODE_ENV === 'development') console.log('MIDTRANS ORDER ID:', midtransOrderId);
...
if (process.env.NODE_ENV === 'development') console.log('DB UPDATED:', internalOrderId, midtransOrderId);
