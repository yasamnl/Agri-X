...
// ============================================================================
// STATUS CONFIG - Konsisten dengan tema hijau
// ============================================================================
              ...
              {order.items.length === 0 ? (
                ...
                <div className="space-y-3">
                  {order.items.map((item) => (
                    ...
                    >
                      {/* Product Image */}
                      <div className="w-20 h-20 bg-background rounded-lg overflow-hidden flex-shrink-0 border border-border">
                        {item.productImage ? (
                          <img 
              ...
              <div className="border-t border-border pt-4 space-y-2">
                ...
                {['pending_payment', 'paid', 'processing'].includes(order.status) && (
                  <button
                    ...
                    className="w-full py-3 rounded-xl font-medium bg-red-50 text-red-600 hover:bg-red-100 border border-red-200 transition-colors flex items-center justify-center gap-2"
                  >
