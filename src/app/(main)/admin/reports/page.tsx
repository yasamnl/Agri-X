...
import {
  ...
  Image as ImageIcon, Calendar, X, Save, ExternalLink, Menu, Flag,
  RotateCcw, Shield, EyeOff, Bell, BellOff, Send, Mail, Info,
  BarChart3, Package, ShoppingCart, Star, Check
} from 'lucide-react';
      ...
      <div className="card bg-surface/50">
        ...
        <div className="space-y-3">
          <div className="flex items-start gap-3">
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-primary to-secondary flex items-center justify-center text-white font-semibold overflow-hidden flex-shrink-0">
    ...
    return (
      <div className="card bg-surface/50">
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-start gap-3">
            <div className="w-8 h-8 rounded-full bg-gradient-to-br from-red-500 to-orange-500 flex items-center justify-center text-white text-xs font-semibold overflow-hidden flex-shrink-0">
              {contextData.author?.avatar ? (
                <img src={contextData.author.avatar} alt="" className="w-full h-full object-cover" />
              ) : (
                contextData.author?.name?.charAt(0).toUpperCase() || 'U'
    ...
    return (
      <div className="card bg-surface/50">
        ...
        <div className="flex gap-4">
          <div className="w-20 h-20 bg-surface rounded-lg overflow-hidden flex-shrink-0 border border-border">
            {contextData.image ? (
    ...
    <div className="min-h-screen bg-background flex">
      ...
      <main className="flex-1 lg:ml-0">
        ...
        <div className="p-4 lg:p-8 space-y-6">
          ...
          {/* Type Counts Cards - 7 TIPE LAPORAN */}
          {typeCounts && (
            <div className="card">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-3">
                {TYPE_OPTIONS.filter(t => t.value !== 'all').map((option) => {
                  ...
                  const percentage = typeCounts.all > 0 ? ((count / typeCounts.all) * 100).toFixed(1) : '0';
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="relative flex items-baseline gap-1">
                        ...
                        {/*{count > 0 && <span className="text-[10px] text-text-secondary">({percentage}%)</span>}*/}
                      </div>
                      ...
                      {/*<div className="relative mt-2 h-1 bg-surface rounded-full overflow-hidden">
                        <div
                          className={`h-full ${option.color} transition-all duration-500`}
                          style={{ width: `${typeCounts.all > 0 ? (count / typeCounts.all) * 100 : 0}%` }}
                        />
                      </div>*/}
                    </button>
                  );
                        ...
                        return (
                          <tr key={report.id} className="hover:bg-surface/50 transition-colors">
                            ...
                            <td className="py-4 px-4">
                              <div className="flex items-center gap-3">
                                ...
                                <div className="min-w-0">
                                  <p className="font-medium text-text-primary truncate max-w-[150px]">{report.reporter.name}</p>
                                  <p className="text-xs text-text-secondary truncate max-w-[150px]">{report.reporter.email}</p>
                                </div>
                              </div>
                            </td>
                            <td className="py-4 px-4">
                            ...
                            <td className="py-4 px-4">
                              {report.resolvedBy ? (
                                <div className="flex items-center gap-2">
                                  <div className="w-7 h-7 rounded-full bg-gradient-to-br from-primary to-secondary flex items-center justify-center text-white text-xs font-semibold overflow-hidden flex-shrink-0">
                                  ...
                                  <span className="text-sm text-text-primary truncate max-w-[100px]">{report.resolvedBy.name}</span>
                                </div>
                              ) : (
                  ...
                  {selectedReport.resolvedBy && !selectedReport.adminNote && (
                    <div>
                      ...
                      <div className="bg-surface rounded-lg p-3 border border-border flex items-center gap-3">
                        <div className="w-8 h-8 rounded-full bg-gradient-to-br from-primary to-secondary flex items-center justify-center text-white text-xs font-semibold overflow-hidden flex-shrink-0">
                          {selectedReport.resolvedBy.avatar ? (
                            <img src={selectedReport.resolvedBy.avatar} alt="" className="w-full h-full object-cover" />
                          ) : (
                            selectedReport.resolvedBy.name?.charAt(0).toUpperCase() || 'A'
                ...
                <div className="space-y-3">
                  ...
                  <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl p-3">
                    <p className="text-xs text-blue-700 dark:text-blue-300">
                      <strong>️ Info:</strong> Setiap perubahan status akan mengirim notifikasi ke pelapor.
                    </p>
                  </div>
                </div>
              </div>
