...
import { ReportModal } from '@/components/reports/ReportModal'; // ✅ IMPORT
...
export default function ProductDetailPage() {
    ...
    try {
      ...
      if (response.data.success) {
        const formattedReviews = (response.data.reviews || []).map((review: any) => ({
          ...
          user_name: review.user_name || review.userName || 'Pengguna',
          user_avatar: review.user_avatar || review.avatar || null,
  ...
  // ✅ UPDATED: Handle Report - Buka Modal
  const handleReport = () => {
    if (!isAuthenticated) {
