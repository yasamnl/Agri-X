...
// ============================================================================
// ✅ INLINE COMPONENT: NotificationDetailModal (dengan template rendering)
// ============================================================================
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        >
          ...
          <div className="p-4 space-y-4">
            {/* Title & Message - ✅ DENGAN TEMPLATE RENDERING */}
            <div>
...
export default function NotificationsPage() {
  ...
  // ✅ State untuk template variables (nama user, dll)
  ...
  // ✅ Fetch user data untuk template variables
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-background pb-24">
            ...
            return (
              ...
              >
                <div className="flex gap-3">
                  ...
                  {/* Content - ✅ DENGAN TEMPLATE RENDERING */}
      ...
      {/* ✅ NOTIFICATION DETAIL MODAL - dengan templateVars */}
