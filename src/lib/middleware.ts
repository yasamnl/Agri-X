...
export function middleware(request: NextRequest) {
  ...
  // ============================================
  // ✅ 1. TRACK REFERRAL CODE (?ref=XXX)
  // ============================================
  const refCode = request.nextUrl.searchParams.get('ref');
  
  if (refCode) {
    if (process.env.NODE_ENV === 'development') console.log(`🔗 [REFERRAL] Detected: ${refCode} on ${pathname}`);
  ...
  // ============================================
  // ✅ 2. HELPER: Build callback URL yang aman
  // ============================================
  ...
  // ============================================
  const protectedRoutes = ['/cart', '/checkout', '/akun', '/orders', '/forum', '/affiliate'];
  ...
  // ============================================
  // ✅ 4. AUTH ROUTES (REDIRECT JIKA SUDAH LOGIN)
  // ============================================
