...
async function trackViaBinderByte(
  ...
  if (process.env.NODE_ENV === 'development') console.log('🔍 [TRACKING] Request:', {
    courier: courier,
  ...
  if (process.env.NODE_ENV === 'development') console.log('🌐 [TRACKING] Calling API:', url);
  ...
  // Log response status
  if (process.env.NODE_ENV === 'development') console.log('📡 [TRACKING] Response status:', response.status);
  ...
  if (process.env.NODE_ENV === 'development') console.log('📦 [TRACKING] Response data:', JSON.stringify(rawData, null, 2));
  ...
  if (process.env.NODE_ENV === 'development') console.log('✅ [TRACKING] Success:', {
