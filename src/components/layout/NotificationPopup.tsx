...
const SenderAvatar = ({ name, avatar, size = 'sm' }: { name?: string; avatar?: string; size?: 'sm' | 'md' }) => {
  ...
  return (
    <div className={`${sizeClasses} rounded-full bg-linear-to-br from-primary to-secondary flex items-center justify-center text-white font-semibold border border-border`}>
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-start justify-between gap-2">
                          ...
                          {!notification.reading && (
                            <span className="w-2 h-2 bg-primary rounded-full shrink-0 mt-1.5" aria-label="Belum dibaca" />
                          )}
                        </div>
