...
import { X, Loader2, Upload, Search, ExternalLink, Check } from 'lucide-react';
...
export function CreatePostModal({ categories, onSuccess }: CreatePostModalProps) {
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div>
          ...
          <textarea
            ...
            className="input w-full min-h-37.5 text-base resize-y focus:ring-2 focus:ring-primary/20"
            required
          />
        </div>
